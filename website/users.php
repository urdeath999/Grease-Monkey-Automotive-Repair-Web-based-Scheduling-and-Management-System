      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form method="POST" action="signin.php" class="sign-in-form">
            ...
            <div class="input-field">
              <input type="password" name="password" id="sign-in-password" placeholder="Password" autocomplete="current-password" required minlength="8" />
          ...
          <form method="POST" action="signup.php" class="sign-up-form" onsubmit="return validatePasswords()">
            ...
            <div class="input-field">
              <input type="password" name="password" id="sign-up-password" placeholder="Password" autocomplete="new-password" required minlength="8" />
              <span class="password-toggle"><i class="fas fa-eye"></i></span>
              <div class="error-message" id="signup-password-error"></div>
            </div>
            <div class="input-field">
              <input type="password" name="confirm_password" id="confirm-password" placeholder="Confirm Password" required minlength="8" />
              <span class="password-toggle"><i class="fas fa-eye"></i></span>
