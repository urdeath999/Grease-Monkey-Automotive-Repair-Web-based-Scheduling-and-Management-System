...
<head>
    ...
    <title>Engine Repair - Grease Monkey</title>
...
<header>
    ...
    <main>
        <section class="slider-container">
            ...
            <div class="slider">
                <div class="slide">
                    <img src="../images/engine1.jpeg" alt="Service Image 1">
                </div>
                <div class="slide">
                    <img src="../images/engine3.jpeg" alt="Service Image 2">
                </div>
                <div class="slide">
                    <img src="../images/engine5.jpeg" alt="Service Image 5">
                </div>
            </div>
        ...
        <div class="slider-content">
            <h2>Engine Repair</h2>
            <p>Diagnosing the problem of your engine then proceeding to fix all the problems that will pop up.</p>
        ...
        <section class="how-it-works">
            ...
            <div class="how-it-works-steps">
                ...
                <div class="number-step">
                    ...
                    <h3>Treatment</h3>
                    <p>Comprehensive engine repair services, including diagnostics, parts replacement, and performance optimization to keep your vehicle running smoothly.</p>
                </div>
            </div>
        </section>
        ...
        <section class="gallery-container">
            ...
            <div class="gallery">
                <div class="gallery-item">
                    <img src="../images/engine2.jpeg" alt="Gallery Image 1" class="gallery-image" onclick="openLightbox(this)">
                </div>
                <div class="gallery-item">
                    <img src="../images/engine4.jpeg" alt="Gallery Image 2" class="gallery-image" onclick="openLightbox(this)">
                </div>
                <div class="gallery-item">
                    <img src="../images/engine6.jpeg" alt="Gallery Image 3" class="gallery-image" onclick="openLightbox(this)">
                </div>
            </div>      
