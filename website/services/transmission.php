...
<head>
    ...
    <title>Transmission Repair - Grease Monkey</title>
...
<header>
    ...
    <main>
        <section class="slider-container">
            ...
            <div class="slider">
                <div class="slide">
                    <img src="../images/trans.jpeg" alt="Service Image 1">
                </div>
                <div class="slide">
                    <img src="../images/trans1.jpeg" alt="Service Image 2">
                </div>
                <div class="slide">
                    <img src="../images/trans3.jpeg" alt="Service Image 5">
                </div>
            </div>
        ...
        <div class="slider-content">
            ...
            <p>Pulling down transmission then replacing all the elements that are causing problem.</p>
            <div class="discount-offer">Earn discounts from booking!</div>
        ...
        <section class="how-it-works">
            ...
            <div class="how-it-works-steps">
                ...
                <div class="number-step">
                    ...
                    <h3>Treatment</h3>
                    <p>Expert transmission repair and maintenance services, including fluid changes, diagnostics, and component replacements to ensure smooth gear shifting and optimal vehicle performance.</p>
                </div>
            </div>
        </section>
        ...
        <section class="gallery-container">
            ...
            <div class="gallery">
                <div class="gallery-item">
                    <img src="../images/trans2.jpeg" alt="Gallery Image 1" class="gallery-image" onclick="openLightbox(this)">
                </div>
                <div class="gallery-item">
                    <img src="../images/trans4.jpeg" alt="Gallery Image 2" class="gallery-image" onclick="openLightbox(this)">
                </div>
                <div class="gallery-item">
                    <img src="../images/trans6.jpeg" alt="Gallery Image 3" class="gallery-image" onclick="openLightbox(this)">
                </div>
            </div>   
        ...
        <section class="brand-we-serve">
                <div class="brand-we-serve-header">
                    <h2>Brand <span class="highlight">We Serve</span></h2>
