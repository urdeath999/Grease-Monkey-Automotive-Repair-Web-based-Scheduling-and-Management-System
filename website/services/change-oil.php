...
<head>
    ...
    <title>Change Oil - Grease Monkey</title>
...
<header>
    ...
    <main>
        <section class="slider-container">
            ...
            <div class="slider">
                <div class="slide">
                    <img src="../images/oil4.jpeg" alt="Service Image 1">
                </div>
                <div class="slide">
                    <img src="../images/oilred.jpeg" alt="Service Image 2">
                </div>
                <div class="slide">
                    <img src="../images/oil6.jpeg" alt="Service Image 5">
                </div>
            </div>
        ...
        <div class="slider-content">
            <h2>Change Oil</h2>
            <p>Draining old engine oil and replacing it with a new clear one.</p>
        ...
        <section class="gallery-container">
            ...
            <div class="gallery">
                <div class="gallery-item">
                    <img src="../images/oil1.jpeg" alt="Gallery Image 1" class="gallery-image" onclick="openLightbox(this)">
                </div>
                <div class="gallery-item">
                    <img src="../images/oil2.jpeg" alt="Gallery Image 2" class="gallery-image" onclick="openLightbox(this)">
                </div>
                <div class="gallery-item">
                    <img src="../images/oil3.jpeg" alt="Gallery Image 3" class="gallery-image" onclick="openLightbox(this)">
                </div>
            </div>      
